# Installing Trench Archaeologist for Codex

Use this guide if you want Codex to discover the reusable `trench-archaeologist` skill from this repository.
...
```bash
git clone https://github.com/anubarakk/trench-archaeologist.git ~/.codex/trench-archaeologist
```
...
4. Symlink the actual skill directory into the discovered skills path:

```bash
ln -s ~/.codex/trench-archaeologist/skills/trench-archaeologist ~/.agents/skills/trench-archaeologist
```

5. Restart Codex so it reloads skills.
